...
export const quizQuestions: Record<number, Question[]> = {
  1: [
    ...
    {
      question: "En quelle année le Père Noël a-t-il été représenté en rouge pour la première fois?",
    ...
    {
      question: "Dans quel pays la tradition des chaussettes de Noël a-t-elle commencé?",
    ...
    {
      question: "Combien de cadeaux sont traditionnellement offerts pendant les 12 jours de Noël?",
    ...
    {
      question: "Dans quel pays la tradition du calendrier de l'Avent a-t-elle débuté?",
      options: ["Suisse", "Allemagne", "Autriche", "France"],
      correctAnswer: 1
    },
    {
      question: "Quel animal tire traditionnellement le traîneau du Père Noël en Scandinavie?",
