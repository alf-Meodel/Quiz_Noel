...
export const DayQuiz: React.FC = () => {
  ...
  const handleAnswer = (selectedIndex: number) => {
    ...
    if (isCorrect) {
      setScores(prev => ({
        ...prev,
        [`player${currentPlayer}`]: prev[`player${currentPlayer}` as keyof typeof prev] + 10
      }));
    }
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white/90 rounded-xl p-8 backdrop-blur-sm max-w-3xl mx-auto">
          <div className="flex justify-between mb-6">
            <span className={`text-xl font-bold ${currentPlayer === 1 ? 'text-teal-600' : 'text-teal-800'}`}>
              Joueur 1: {scores.player1} points
            </span>
            <span className={`text-xl font-bold ${currentPlayer === 2 ? 'text-teal-600' : 'text-teal-800'}`}>
          ...
          {!isGameOver ? (
            showAnswer ? (
              <AnswerScreen
                ...
                correctAnswer={questions[currentQuestion % questions.length].options[
              ...
              <div className="space-y-6">
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-teal-600">
                    Question {Math.floor(currentQuestion / 2) + 1}/{questions.length}
                  </p>
                </div>
            ...
            <div className="text-center">
              <h2 className="text-2xl font-bold text-teal-800 mb-4">Quiz terminé !</h2>
