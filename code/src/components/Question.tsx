...
export const Question: React.FC<QuestionProps> = ({ question, onAnswer, playerName }) => {
  return (
    <div className="w-full max-w-2xl p-6 bg-white/90 rounded-xl shadow-lg backdrop-blur-sm">
      <div className="mb-6">
        <p className="text-teal-600 text-lg font-medium">C'est au tour de {playerName}</p>
        <h3 className="text-2xl font-bold text-teal-800 mt-2">{question.question}</h3>
      </div>
